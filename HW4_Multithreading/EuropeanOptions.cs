...
namespace HW4_Multithreading
{
    class EuropeanOptions : Simulator
    {
        ...
        public  double GetDelta()
        {
            ...
            E2.SpotPrice = this.SpotPrice * (1 - 0.0001);
            ...
            return (E1.OptionPrice() - E2.OptionPrice()) / (0.0002*SpotPrice);
        ...
        public double GetGamma()
        {
            ...
            return (E1.OptionPrice() -2*OptionPrice()+ E2.OptionPrice()) / Math.Pow(0.0001*SpotPrice,2);
        ...
        public  double GetVega()
        {
            ...
            E1.SprikePrice = SprikePrice;
            E1.Drift = Drift;
            E1.Volatility = Volatility*(1+0.0001);
            E1.Tenor = Tenor;
            E1.TrialNumber = TrialNumber;
            E1.StepNumber = StepNumber;
            E1.Side = Side;
            ...
            E2.SprikePrice = SprikePrice;
            E2.Drift = Drift;
            E2.Volatility = Volatility*(1-0.0001);
            E2.Tenor = Tenor;
            E2.TrialNumber = TrialNumber;
            E2.StepNumber = StepNumber;
            E2.Side = Side;
            ...
            E2.RandNumbers = RandNumbers;
            #endregion instance 2
            return (E1.OptionPrice() - E2.OptionPrice()) / (0.0002 * Volatility);
        ...
        public  double GetTheta()
        {
            ...
            return (E1.OptionPrice() - OptionPrice()) / (0.0001 * Tenor);
            #endregion instance 1
        ...
        public  double GetRho()
        {
            ...
            E2.RandNumbers = RandNumbers;
            #endregion instance 2
            return (E1.OptionPrice() - E2.OptionPrice()) / (0.0002 * Drift);
